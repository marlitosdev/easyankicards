...
async function testes() {
  ...
  /* ---- B7: os botoes na bancada ---- */
  {
    ...
    ok(a.$("dlgCartElevar").open === true && a.ceEscopoAtual() === "bancada" && /3 cartão\(ões\) em “Só a bancada”/.test(a.$("ceResumo").textContent), `B7b o botao da bancada abre o Melhorar cartoes ja so' nos cartoes da bancada: ${a.$("ceResumo").textContent}`);
