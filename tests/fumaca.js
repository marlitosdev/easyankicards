...
function rodar() {
  ...
  const exportar = `return {
    ...
    lerEdital, priorizar, montarPlano, edEstadoDosRamos, edTempoDosRamos, edPainelRamos, edRamosRegistrar, edRamosDesfazer, edPesosDosRamos, edAcharItemDoTopico, edTopicosPendentes, semanaAtual, semanasAte, edDetectores,
