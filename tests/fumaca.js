...
const ARQUIVOS = ["i18n.js", "parser.js", "anki.js", "app.js",
                  ...
                  "cartao-melhorar.js", "lei-seca.js", "lei-ui.js", "questoes.js", "rascunho.js", "copiar-questao.js", "grifo.js", "geracao-log.js", "registro-tudo.js", "decisoes.js", "lixeira.js", "cartao-qualidade.js", "cartao-elevar.js", "gerenciador.js", "estudo-cartoes.js", "cobertura-cartoes.js", "banca-alvo.js", "horas-assunto.js", "ramos.js", "pacote.js",
  "dificuldade.js",
...
function rodar() {
  ...
  const exportar = `return {
    ...
    recortarCartao, excluirCartao, colarRecortes,
    ...
    leiTextoDoTopico, leiAvisoNomePintar, leiRelatorioVinculos, leiAlvosCtx, leiAlvoEscolher, leiAlteracoesRecebidas, leiAlteracoesDe, leiChipsRecebidos, leiFaixaAlvoPintar, leiLacunaChip, leiLacunaClique, leiConsultaAbrir, leiCitacaoHtml, leiLacunasRegAtual: () => leiLacunasReg, leiAlvoCtxAtual: () => leiAlvoCtx, leiSecoes, leiArtigosDaSecao, leiAlvosCandidatos, leiArtigoDoAlvo, leiDispositivos, leiDescreverLacuna, leiLacunasDoBloco, leiArtigoParaConsulta, leiIdentidadeTela, leiIdentidadeDesfazerTela, leiIdentBotoes, leiIdentidadeDivergente, leiIdentidadesDivergentes, leiCorrigirIdentidades, leiIdentidadesDesfazer, leiIdentidadesRecibo, leiAplicarNoTopico, leiEtiquetaDe, leiDoTopicoAtual,
    ...
    leiSepararColagem,
    leiPreprocessar, leiAplicarPreprocesso, leiRepetidosNoArtigo, leiSugerirEntre,
    leiNumeracao, leiNormalizaComparacao, leiForaDaSequencia, leiPareceAlteradora,
    leiConfereIdentidade, leiCoberturaDaAtualizacao, leiAlertasDaMudanca, leiCompararVersoes, leiDiffLinhas,
    leiGrafiaDaLinha, leiPreAnalisar, leiNumeracaoLinhas, leiNumeracaoDaLei, leiUpdGuardas,
    leiRevisarColagemAbrir, leiPrePintar, leiPreConfirmar, leiPreOriginal, leiPreCancelar,
    leiPreSugestoes, leiPreCtxAtual: () => leiPreCtx,
    leiUpdGuardaAbrir, leiCobPintar, leiCobConfirmar, leiCobCancelar, leiCobCtxAtual: () => leiCobCtx,
    leiUpdModoAusentesAtual: () => leiUpdModoAusentes, leiPintarAnexos,
    ...
    leiJaAbrir, leiJaPintar, leiJaConfirmar, leiJaCancelar, leiJaCtxAtual: () => leiJaCtx, leiUsarExistente,
    leiBibAbrir, leiBibPintar, leiBibLista, leiBibCartao, leiUsosDaLei, leiAbrirAvulsa,
    leiBibFiltrar: (f, q) => { leiBibFiltro = f; leiBibTexto = q || ""; },
    leiBibApagar, leiBibDesligar, leiDesligarTopico, leiConsequenciaDesligar,
    leiTopicoAbrir, leiTopicoPintar, leiTopicosDisponiveis, leiTopCtxAtual: () => leiTopCtx,
    leiEstruturaArtigo, leiLerRotulo, leiRomanoValor, leiValorRomano, leiRotuloDaUnidade, leiContextoDeLinhas, leiLerFaixaRevogada,
    leiDupContextoEl, leiRelatorioFluxo, leiRelatorioCopiar, leiSeguro,
    leiAcharUnidades, leiConsumirEndereco,
    citVinculosLer, citVinculosGravar, citChave, citLerArtigos, citVinculoSalvar, citVinculoRemover, citVinculosAplicar,
    leiIrUnidade, leiLinhasDesenhadas, leiBlocoDoArtigo, qsVincAbrir, qsVincPintar, qsVincEscolher, qsVincSalvar, qsVincBotao, qsVincSelecao,
    qsVincCtxAtual: () => qsVincCtx,
    ...
    ramIdDoCartao, ramCartaoComRamo, ramRetagar, ramAtribuir, ramAplicar, ramAbrirEditor, ramAdicionar, ramSalvar, ramSugerirDaLei, ramProporDaLei, ramContaCitacoes, ramTextosPorFonte, ramMaterialDoTopico, ramPedidoIA, jurGravarTudo, ramDivergencias, ramTextoDaLei, ramIdentidadeDoNome, ramLeiCombina, ramLeisCandidatas, ramLeiPadrao, ramLeiResumo, ramLeiEscolhida, ramLeiBloqueada, ramLeiTrocar, ramLeiVer, ramLeiFixar, ramAcertosDoTopico, ramAcertoFraco, RAM_ACERTO_AMOSTRA, RAM_ACERTO_CORTE, ramPesosPorRegistros, ramPesosDosRegistros, ramTextosDoTopico, ramRadicais, ramLerRespostaIA, ramPedirIA, ramConferirIA, ramMover, ramPintar, RAM_DICAS, RAM_GERAL, gerContextoRamos, gerAbrirRamos, gerTemRecibo, gerConfirmarRamo, gerSoltarRamo, gerDesfazerUltima, ramLinhasAtual: () => ramLinhas, ramCtxAtual: () => ramCtx,
    ...
    genOrigemAtual: () => genOrigem,
    genPendenteAtual: () => genPendente,
    genPendenteTeste: (v) => { genPendente = v; },
    ...
    rtDaVinculacao,
    rtPintar, rtIniciarTela, rtLimparErros,
    rtDaLei, rtRelatorio, rtAssuntosDe, rtSemRepetidos, rtContarPorAssunto,
    rtEhErroFixo, rtOpcoesAtuais, rtPintarControles, RT_ASSUNTOS,
    diagAssuntoPadrao,
    get diagAssunto() { return diagAssunto; },
    get diagGravidade() { return diagGravidade; },
    diagDefinir: (a, g) => { if (a) diagAssunto = a; if (g) diagGravidade = g; },
    get regPeriodo() { return regPeriodo; },
    definirPeriodo: (p) => { regPeriodo = p; },
    bkDiasDeCalendario,
    ...
    jurPromptMelhorar, jurMelAbrir, jurMelConferir, jurMelAplicar,
