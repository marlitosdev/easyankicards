...
function rodar() {
  ...
  const exportar = `return {
    ...
    leiTextoDoTopico, leiAvisoNomePintar, leiRelatorioVinculos, leiIdentidadeTela, leiIdentidadeDesfazerTela, leiIdentBotoes, leiIdentidadeDivergente, leiIdentidadesDivergentes, leiCorrigirIdentidades, leiIdentidadesDesfazer, leiIdentidadesRecibo, leiAplicarNoTopico, leiEtiquetaDe, leiDoTopicoAtual,
