...
function rodar() {
  ...
  const exportar = `return {
    ...
    lerEdital, priorizar, montarPlano, edEstadoDosRamos, edTempoDosRamos, edCredito, edCreditoRev, edRestante, somarPeso, edPainelRamos, edRamosRegistrar, edRamosDesfazer, edPesosDosRamos, edAcharItemDoTopico, edTopicosPendentes, semanaAtual, semanasAte, edDetectores,
