...
function rodar() {
  ...
  const exportar = `return {
    ...
    leiConfereIdentidade, leiCoberturaDaAtualizacao, leiAlertasDaMudanca, leiCompararVersoes,
    ...
    leiBibApagar, leiBibDesligar, leiDesligarTopico,
