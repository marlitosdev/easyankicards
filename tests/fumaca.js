...
function rodar() {
  ...
  const exportar = `return {
    ...
    ceTrocarObjetivo, ceObjetivoAtual: () => ceObjetivo, CE_OBJETIVOS, CE_ALVO, ceServeAoObjetivo, ceChaveCartao, ceAplicarLote, ceRecibo, ceDesfazerLote, ceCalcular, cePintar, ceMarcarPiores, ceGerarPrompt, ceConferirColagem, ceAplicar, ceDesfazer, ceAbrir,
