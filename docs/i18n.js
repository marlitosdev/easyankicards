...
const UI = {
 "pt": {
  ...
  "rev_prompt_short": "Aprimore os flashcards que já existem abaixo, sem criar novos nem mudar o tema de cada um. Confira-os contra as fontes deste notebook e complemente/corrija os erros de conteúdo (artigos, datas, valores, percentuais). Mantenha o formato exato: um por linha, \"Pergunta :: Resposta :: tags\", {{c1::...}}, \"@\" título acima, \"+\" explicação abaixo. Responda só com os cartões corrigidos.\n\nCARTÕES:\n{cards}",
 ...
 "en": {
  ...
  "rev_prompt_short": "Improve the EXISTING flashcards below, without creating new ones or changing each one's topic. Check them against this notebook's sources and complement/fix content errors (articles, dates, values, percentages). Keep the exact format: one per line, \"Question :: Answer :: tags\", {{c1::...}}, \"@\" title above, \"+\" explanation below. Reply only with the corrected cards.\n\nCARDS:\n{cards}",
